...
@date - 09/29/2015
@description - The program create an animated page that displays at least
            3 polygons and 3 points where the points will change color when
            they are 'inside' a pology, and the polygons will change direction
            when they 'collide' with another polygon.

            Note for the current program the three pologies shouldnot overlap
...
class Driver(pantograph.PantographHandler):
    """Driver of the animate program that sets up points and pologies and moves them and
    updates their attributes accordingly.
    """

    def setup(self):
        """Set up the points and pologies, including color, directions, etc.
        """ 
        self.p1 = Point(494, 138)
        self.p2 = Point(self.width/2, self.height/2)
        self.p3 = Point(500, 400)
        self.p1.set_direction("E")
        self.p2.set_direction("NE")
        self.p3.set_direction("S")
        self.p1.color = "#0F0"
        self.p2.color = "#0F0"
        self.p3.color = "#0F0"

        self.poly2 = Polygon([(647,471),(663,340),(731,299),(827,322),(858,450),(797,503),(731,512)])
        self.poly1 = Polygon([(367, 367),(444, 413),(504, 384),(519, 307),(453, 248),(380, 250),(365, 278),(374, 325)])
        self.poly3 = Polygon([(134, 138), (171,140), (236,144),  (317,179), (323,229), (187,299), (150,280)])
    ...
    def drawShapes(self):
        """Draw points and pologies on the canvas."""
        ...
        self.fill_oval(self.p1.x, self.p1.y, 7, 7, self.p1.color)
        self.fill_oval(self.p2.x, self.p2.y, 7, 7, self.p2.color)        
        self.fill_oval(self.p3.x, self.p3.y, 7, 7, self.p3.color)
        
        
        
    """
    @function hitWall
    Check if points or pologies hit a wall and change their directions accordingly.
    ...
    @returns character - The axis ('x' or 'y') of the wall if the points hits it, or None if not.
    """
    ...
    @param - axis: the axis hit by a point or a pology
    @returns - The new direction after hit the wall.
    """
    ...
    """
    @function pointsInPology

    Check if some of the three points are in one of the three pologies.
    If yes, change color of the point.
    """
    def pointsInPology(self):
        for p in [self.p1, self.p2, self.p3]:
            for poly in [self.poly1, self.poly2, self.poly3]:
    ...
    """
    @function pologyCollide

    Check if one of the three pologies collides with another.
    If yes, reverse their directions respectively.
    """
    def pologyCollide(self, prepoly1, prepoly2, prepoly3):
    ...
    @param - Direction: current direction
    @returns - The new direction after collision.
    """
    ...
    """
    @function update
    Update the attributes of points and pologies after a interval, such as position, direction and color.
    """
    def update(self):
        ...
        # check hitwall, point inside pology and collision
        self.pointsInPology()
        self.hitWall()
        self.pologyCollide(prepoly1, prepoly2, prepoly3)
